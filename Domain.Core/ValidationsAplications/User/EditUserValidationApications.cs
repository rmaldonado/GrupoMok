...
{
    public class EditUserValidationApications: IEditUserValidationApications
    {
            ...
            public async Task<Validation> ValidateUserCreate(UserRequestEdit request)
            {
                ...
                messageValidation = await ValidationSecondLastName(request.SecondLastName);
                if (!messageValidation.Value.Equals(Constants.OK))
                {
                    validation.Code = messageValidation.Name;
                    validation.Validate = false;
            ...
            messageValidation = await ValidationDocumentType(request.DocumentType.ToString());
                ...
                messageValidation = await ValidationPublickey(request.PublicKey);
                if (!messageValidation.Value.Equals(Constants.OK))
                {
                    validation.Code = messageValidation.Name;
                    validation.Validate = false;
                ...
                messageValidation = await ValidationauditCreateUser(request.AuditUpdateUser.ToString());
                if (!messageValidation.Value.Equals(Constants.OK))
                {
                    validation.Code = messageValidation.Name;
                    validation.Validate = false;
                ...
                messageValidation = await ValidationauditCreateDate(request.AuditUpdateDate.ToString());
                if (!messageValidation.Value.Equals(Constants.OK))
                {
                    validation.Code = messageValidation.Name;
                    validation.Validate = false;
            ...
            private async Task<DataItem> ValidationName(string Name)
            {
                ...
                //if (!Regex.IsMatch(Name.Trim(), RegExpText)) return await MessageValidationName("N05");
        ...
        private async Task<DataItem> ValidationSecondLastName(string SecondLastName)
        {
            DataItem lista = new DataItem();
            if (string.IsNullOrEmpty(SecondLastName)) return await MessageValidationLasName("MC1");
            if (string.IsNullOrWhiteSpace(SecondLastName)) return await MessageValidationLasName("MC2");
            if (SecondLastName.Trim().Length < 5) return await MessageValidationLasName("MC3");
            if (SecondLastName.Trim().Length > 15) return await MessageValidationLasName("MC4");
            if (!Regex.IsMatch(SecondLastName.Trim(), RegExpText)) return await MessageValidationLasName("MC5");
        ...
        private async Task<DataItem> ValidationDocumentType(string DocumentType)
            ...
            private async Task<DataItem> ValidationdocumentNumber(string documentNumber)
            {
                ...
                //if (!Regex.IsMatch(documentNumber.Trim(), RegExpText)) return await MessageValidationDocumentNumber("DN05");
            ...
            private async Task<DataItem> ValidationUserName(string UserName)
            {
                ...
                if (UserName.Trim().Length < 6) return await MessageValidationUserName("U03");
                if (UserName.Trim().Length > 15) return await MessageValidationUserName("U04");
                //if (!Regex.IsMatch(UserName.Trim(), RegExpText)) return await MessageValidationUserName("U05");
            ...
            private async Task<DataItem> Validationpassword(string password)
            {
                ...
                if (password.Trim().Length < 7) return await MessageValidationpassword("P03");
                if (password.Trim().Length > 15) return await MessageValidationpassword("P04");
                //if (!Regex.IsMatch(password.Trim(), RegExpText)) return await MessageValidationpassword("P05");
            ...
            private async Task<DataItem> Validationemail(string email)
            {
                ...
                if (email.Trim().Length < 10) return await MessageValidationemail("E03");
                if (email.Trim().Length > 25) return await MessageValidationemail("E04");
                //if (!Regex.IsMatch(email.Trim(), RegExpText)) return await MessageValidationemail("E05");

                lista = new DataItem { Name = "00", Value = Constants.OK };
                return await Task.Run(() => lista);
            }

            private async Task<DataItem> ValidationPublickey(string KeyPublic)
            {
                DataItem lista = new DataItem();
                if (string.IsNullOrEmpty(KeyPublic)) return await MessageValidationPublickey("K01");
                if (string.IsNullOrWhiteSpace(KeyPublic)) return await MessageValidationPublickey("K02");
                if (KeyPublic.Trim().Length < 16) return await MessageValidationPublickey("K03");
                if (KeyPublic.Trim().Length > 400) return await MessageValidationPublickey("K04");
                if (!Regex.IsMatch(KeyPublic.Trim(), RegExpText)) return await MessageValidationPublickey("K05");
            ...
            private async Task<DataItem> Validationstate(string state)
            {
                ...
                //if (!Regex.IsMatch(state.Trim(), RegExpText)) return await MessageValidationstate("ST05");
            ...
            private async Task<DataItem> ValidationauditCreateDate(string auditCreateUser)
            {
                ...
                if (auditCreateUser.Trim().Length < 8) return await MessageValidationauditCreateDate("AD03");
                if (auditCreateUser.Trim().Length > 25) return await MessageValidationauditCreateDate("AD04");
            ...
            private async Task<DataItem> MessageValidationName(string code)
            {
                ...
                switch (code)
                {
                    ...
                    case "N03":
                        ...
                        {
                            Name = "99",
                            Value = "El Campo Name debe tener al menos 8 caracteres"
                        };
                        break;
                    case "N04":
                        lista = new DataItem
                    ...
                    case "N05":
                        ...
                        {
                            Name = "99",
                            Value = "El Campo Name no cumple con los requisitos (Debe tener al menos 10 caracteres,)"
                        };
                        break;
                    default:
                        break;
            ...
            private async Task<DataItem> MessageValidationDocumentType(string code)
            {
                ...
                switch (code)
                {
                    ...
                    case "D04":
                        ...
                        {
                            Name = "99",
                            Value = "El Campo DocumentType no puede mayor que 15 digitos"
                        };
                        break;
                    default:
                        break;
            ...
            private async Task<DataItem> MessageValidationemail(string code)
            {
                ...
                switch (code)
                {
                    ...
                    case "E03":
                        ...
                        {
                            Name = "99",
                            Value = "El Campo email debe tener al menos 8 caracteres"
                        };
                        break;
                    case "E04":
                        lista = new DataItem
                        {
                            Name = "99",
                            Value = "El Campo email no puede mayor que 15 digitos"
                        };
                        break;
                    case "E05":
                        lista = new DataItem
                        {
                            Name = "99",
                            Value = "El Campo email no cumple con los requisitos (Debe tener al menos 10 caracteres,)"
                        };
                        break;
                    default:
                        break;
            ...
            private async Task<DataItem> MessageValidationPublickey(string code)
            {
                DataItem lista = new DataItem();
                ...
                switch (code)
                {
                    ...
                    case "K03":
                        ...
                        {
                            Name = "99",
                            Value = "El Campo KeyPublic debe tener al menos 8 caracteres"
                        };
                        break;
                    case "K04":
                        lista = new DataItem
                        {
                            Name = "99",
                            Value = "El Campo KeyPublic no puede mayor que 15 digitos"
                        };
                        break;
                    case "K05":
                        lista = new DataItem
                        {
                            Name = "99",
                            Value = "El Campo KeyPublic no cumple con los requisitos (Debe tener al menos 10 caracteres,)"
                        };
                        break;
                    default:
                        break;
            ...
            private async Task<DataItem> MessageValidationstate(string code)
            {
                ...
                switch (code)
                {
                    ...
                    case "ST03":
                        ...
                        {
                            Name = "99",
                            Value = "El valor no es el adecuado, intente de nuevo"
                        };
                        break;
                    case "ST04":
                        lista = new DataItem
                        {
                            Name = "99",
                            Value = "El Campo state no puede mayor que 15 digitos"
                        };
                        break;
                    case "ST05":
                        lista = new DataItem
                        {
                            Name = "99",
                            Value = "El Campo state no cumple con los requisitos (Debe tener al menos 10 caracteres,)"
                        };
                        break;
                    default:
                        break;
            ...
            private async Task<DataItem> MessageValidationauditCreateUser(string code)
            {
                ...
                switch (code)
                {
                    ...
                    case "AU03":
                        ...
                        {
                            Name = "99",
                            Value = "El Campo auditCreateUser no es el adecuado intente de nuevo"
                        };
                        break;
                    case "AU04":
                        lista = new DataItem
                        {
                            Name = "99",
                            Value = "El Campo auditCreateUser no puede mayor que 15 digitos"
                        };
                        break;
            ...
            private async Task<DataItem> MessageValidationauditCreateDate(string code)
            {
                ...
                switch (code)
                {
                    ...
                    case "AD03":
                        ...
                        {
                            Name = "99",
                            Value = "El Campo auditCreateDate debe tener al menos 8 caracteres"
                        };
                        break;
                    case "AD04":
                        lista = new DataItem
                        {
                            Name = "99",
                            Value = "El Campo auditCreateDate no puede mayor que 15 digitos"
                        };
                        break;
                    case "AD05":
                        lista = new DataItem
                        {
                            Name = "99",
                            Value = "El Campo auditCreateDate no cumple con los requisitos (Debe tener al menos 10 caracteres,)"
                        };
                        break;
                    default:
                        break;

...
namespace Domain.Core.ValidationsAplications.User
{
    public class EditCompanysValidationsAplications: IEditCompanysValidationsAplications
    {
        ...
        public async Task<Validation> ValidateCompanys(CompanyRequestEditDto request)
        {
